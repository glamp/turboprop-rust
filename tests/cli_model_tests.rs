...
async fn test_model_list_cache_status() -> Result<()> {
    ...
    output
        .stdout(predicate::str::contains("cached").or(predicate::str::contains("download required")));
...
async fn test_model_list_help() -> Result<()> {
    ...
    cmd.assert()
        .success()
        .stdout(predicate::str::contains("List all available embedding models"));
...
async fn test_model_info_help() -> Result<()> {
    ...
    cmd.assert()
        .success()
        .stdout(predicate::str::contains("Show detailed information about a specific model"));
